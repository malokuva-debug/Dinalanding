      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-5 pb-20 pt-14 md:px-8 lg:grid-cols-[1.15fr_0.85fr] lg:pb-28 lg:pt-24">
        <div className="min-w-0">
          ...
          >
            {data.titleLine1}
            <br />
            <em className="text-sheen pr-2">{data.titleLine2Emphasis}</em>
          </motion.h1>
          ...
          >
            {data.stats.map((s) => (
              <div key={s.id} className="flex items-center gap-3">
                <span className="font-display text-3xl text-cream">{s.value}</span>
        ...
        >
          ...
          <div className="glass-strong animate-float absolute -left-3 bottom-16 flex items-center gap-3 rounded-2xl px-4 py-3 shadow-2xl md:-left-6">
            ...
            <div>
              <p className="text-[12px] font-semibold text-cream">{data.badgeTitle}</p>
              <p className="text-[11px] text-mist">{data.badgeSubtitle}</p>
            </div>
          </div>
